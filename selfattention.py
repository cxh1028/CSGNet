...
class SelfAttentionBlock(nn.Module):
    ...
    def forward(self, query_feats, key_feats):
        ...
        # query_feats = query_feats.reshape(query_feats.shape[0],query_feats.shape[1],query_feats.shape[2],query_feats.shape[3]*query_feats.shape[4])
        # print("111111111111111e3ed")
